...
//    	System.out.println(connections.get(0).getrssi());
//    	System.out.println(connections.get(0).getssid());
//    	if (this.connections.get(0).getbssid().equals("14:60:80:61:33:b0")){
//    		this.room="Krevatokamara";
//    	}
//    	else if (this.connections.get(0).getbssid().equals("78:96:82:33:b5:16")){
//    		if (this.connections.get(0).getrssi()>-42){
//    			this.room="Xol, Router";
//    		}
//    		else if (this.connections.get(0).getrssi()>-75){
//    			this.room="Domatio mou";
//    		}
//    		else if (this.connections.get(0).getrssi()>-95){
//    			this.room="Saloni";
//    		}
//    		
//    	}
